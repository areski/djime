...
urlpatterns = patterns('djime.views',
    url(r'^$', 'timesheet', name='djime_timesheet'),
    url(r'^(?P<method>(week|month|quarter|year))/$', 'timesheet', name='djime_this_wmqy_timesheet'),
    url(r'^(?P<method>(week|month|quarter|year))/(?P<method_value>\d{1,4})/$', 'timesheet', name='djime_wmqy_timesheet'),
    url(r'^(?P<method>(week|month|quarter))/(?P<method_value>[1-9]|[1-4][0-9]|5[0-3])/year/(?P<year>\d{4,4})/$', 'timesheet', name='djime_wmq_timesheet'),
    url(r'^date/(?P<start_date>[0-9-]+)/(?P<end_date>[0-9-]+)/$', 'timesheet_date', name='djime_date_timesheet'),
    url(r'^select/$', 'timesheet_select_form', name='djime_select_timesheet'),
